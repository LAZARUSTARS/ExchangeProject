...
namespace ExchangeProject
{
    public partial class FStock1 : Form
    {
        ...
        private void FStock1_Load(object sender, EventArgs e)
        {
            ...
            SQLiteConnection connection = new SQLiteConnection("Integrated Security = SSPI; Data Source = northwind.db");
            connection.Open();
            var command = connection.CreateCommand();
            command.CommandText = @"SELECT  idstock, name, description, ticker, logo, currentCap, EV/EBITDA, price1, price2, price3, price4, price5, price6, price7, price8, price9, price10, price11, price12, price13, price14, price15, price16, price17, price18, price19, price20 FROM Exchange";
            ...
            {
                this.chart1.Series["Series1"].Points.AddXY(class2[i].ProductName1, class2[i].UnitPrice1);
            }
        }
    }
}
