    ...
    public partial class Form1 : Form
    {
        ...
        private void getJsonData(string ticker, FStock1 form)
        {
            ...
            using (var client = new HttpClient())
            {
                ...
                form.SetChart(priceData, startTime, endTime, "hourly");
            }
        }
        ...
        private void button7_Click(object sender, EventArgs e)
        {
            ...
            form7.SetText("ОАК", "18.9", "ПАО «Объединённая авиастрои́тельная корпорация» («ОАК») — российская авиастроительная корпорация, одна из крупнейших в Европе. Объединяет крупные авиастроительные предприятия России. Зарегистрирована 20 ноября 2006 года (до апреля 2015 года называлась ОАО «ОАК»).", "792000000000");
